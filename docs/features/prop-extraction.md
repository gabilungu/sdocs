...
The supported types are `color` (→ color picker) and `dimension` (→ number + px unit). See [interactive controls](./interactive-controls.md).
...
- [Interactive controls](./interactive-controls.md) — how extracted props become UI controls
- [Writing component docs](../writing-docs/component-sdoc.md)
