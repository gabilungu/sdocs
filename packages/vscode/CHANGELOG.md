...
- `args={{ … }}` accepts `null`, so a nullable prop value no longer flags the
  whole args object as invalid.

## [0.0.60] - 2026-07-12

### Removed

- The `[preview]` tag is gone (use `[component]`): completions, the new-doc
  template, hover, and the grammar no longer mention it.
