...
See [prop extraction](/docs/features/prop-extraction) for the full extraction rules.
...
- [Prop extraction](/docs/features/prop-extraction) — how sdocs parses your component
- [Writing component docs](/docs/writing-docs/component-sdoc) — the `Default` snippet and `args`
