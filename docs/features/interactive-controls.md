...
See [prop extraction](./prop-extraction.md) for the full extraction rules.
...
- [Prop extraction](./prop-extraction.md) — how sdocs parses your component
- [Writing component docs](../writing-docs/component-sdoc.md) — the `Default` snippet and `args`
