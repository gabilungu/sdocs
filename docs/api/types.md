...
See the [configuration reference](../usage/configuration.md) for field semantics.
...
- [Prop extraction](../features/prop-extraction.md) — what gets populated into these types
- [Embedded usage](../usage/embedded-vite.md) — consuming `virtual:sdocs`
