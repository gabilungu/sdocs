...
The imported component. sdocs reads its source to extract props, events, snippets, methods, state, and CSS custom properties. See [prop extraction](/docs/features/prop-extraction) for what exactly is parsed.
...
See [sidebar](/docs/features/sidebar) for ordering rules.
...
See [interactive controls](/docs/features/interactive-controls) for which prop types get which control.
...
- [Interactive controls](/docs/features/interactive-controls) — full list of control types
- [Prop extraction](/docs/features/prop-extraction) — what sdocs parses from your component
- [Page docs](/docs/writing-docs/page-sdoc) — for freeform prose
- [Layout docs](/docs/writing-docs/layout-sdoc) — for component compositions
